            ...
            <div class="card" style="width: 70%;margin: auto;">
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <h2>Excluir conta</h2>
                        <p>Se quiser dar um tempo do GoCare, você pode <a href="perfilmotoristadesativar.php">desativar</a> temporariamente a sua conta, em vez de excluí-la. Seu perfil não aparecerá no GoCare enquanto estiver ausente.</p>

                        <hr>
                        
                        <form action="excluicontamotorista.php" method="post" style="margin: 1% 2%;">
                            <div class="form-row">
