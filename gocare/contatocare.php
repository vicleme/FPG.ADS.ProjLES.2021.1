            ...
            <section id="entrarpassageiromotorista">
                <div class="container-fluid" style="width: 90%;margin-top: 5%; margin-bottom: 5%;">
                        ...
                        <div class="card mb-3" style="align-content: center;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="img\phone.png" style="width: 80%; margin: 1%">

                            
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h3 class="card-title-primary">Entre em contato</h3>
                                        <hr>
                                        <p class="card-text text-break">
                                            Nós da GoCare estamos sempre disponíveis para atendê-lo da melhor forma, atualmente sediados na cidade de Praia Grande, Rua Rubens Ferreira Martins, 100 - Guilhermina. 
                                        </p>
                                        <p class="card-text text-break">
                                            Infromações para contato:<br>
                                            Telefone:13 98817-2714<br>
                                            E-mail: gocare.les@gmail.com<br>
                                        </p>
                                        <p class="card-text text-break">
                                            Vamos conversar?<br>
                                            Qualquer dúvida sobre nossos serviços pode ser respondida aqui e agora!!<br>
                                            WeCare.<br>
                                        </p>
