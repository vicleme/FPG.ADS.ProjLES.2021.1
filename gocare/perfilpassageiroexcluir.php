            ...
            <div class="card" style="width: 70%;margin: auto;">
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <h2>Excluir conta</h2>
                        <p>Se quiser dar um tempo do GoCare, você pode <a href="perfilpassageirodesativar.php">desativar</a> temporariamente a sua conta, em vez de excluí-la. Seu perfil não aparecerá no GoCare enquanto estiver ausente.</p>

                        <hr>
                        
                        <form action="excluicontapassageiro.php" method="post" style="margin: 1% 2%;">
                            <div class="form-row">
                            <div class="form-group col-md-7" style="margin-left: auto;margin-right: auto;">
                                <p>Por que você está excluindo sua conta? </p>
                                <label for="motivoexclusao" class="sr-only">Motivo da exclusão</label>
                                <select class="form-control" id="motivoexclusao" name="fmotivoexclusao" required>
                            ...
                            <p>Se continuar, os detalhes da sua conta e perfil serão excluídos.</p>

                            <button type="submit" class="btn btn-primary btn-block col-md-6" style="margin-top:11px;margin-bottom:16px;margin-left:auto;margin-right:auto">Excluir conta</button>
                    ...
                    <div style="width: fit-content;margin-left: auto;text-align: center;margin-top:16px;">
                        ...
                        <a href="perfilpassageiroedita.php" class="card-link"><i class="fas fa-pencil-alt"></i>  Editar perfil</a>
                    </div>
