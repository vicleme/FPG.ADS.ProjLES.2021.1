...
<body style="background-color:rgb(87, 154, 210)">
            ...
            <div class="card" style="width: 70%;margin: auto;">
                <div class="card-body">
                    <div style="text-align: center;margin:20px 20px 0px 20px">
                        ...
                        <h2>Altere sua viagem</h2>
                    </div>
                    <form action="alteracorridapassageiro.php" method="post" style="padding: 5%">
                        <div class="form-row">
                        <div class="col-md-8">
                            <label for="validationDefault01">Endereço de saída:</label>
                            <input type="text" name="fenderecosaida" class="form-control" id="validationDefault01" value="<?php echo $_POST['fenderecosaida'];?>" required>
                        </div>
                        <div class="col-md-4">
                            <label for="validationDefault02">Cidade:</label>
                            <input type="text" name="fcidadesaida" class="form-control" id="validationDefault02" value="<?php echo $_POST['fcidadesaida'];?>" required>
                        </div>
                        </div>
                        <div class="form-row" style="margin-top: 2%">
                        <div class="col-md-8">
                            <label for="validationDefault03">Endereço de chegada:</label>
                            <input type="text" name="fenderecochegada" class="form-control" id="validationDefault03" value="<?php echo $_POST['fenderecochegada'];?>" required>
                        </div>
                        <div class="col-md-4">
                            <label for="validationDefault04">Cidade:</label>
                            <input type="text" name="fcidadechegada" class="form-control" id="validationDefault04" value="<?php echo $_POST['fcidadechegada'];?>" required>
                        </div>
                        </div>
                        <div class="form-row" style="margin-top: 2%">
                        <div class="col-md-3 mb-3">
                            <label for="validationDefault05">Horário:</label>
                            <input type="time" name="fhorario" class="form-control" id="validationDefault05" value="<?php echo $_POST['fhorario'];?>" required>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="validationDefault06">Data:</label>
                            <input type="date" name="fdatav" class="form-control" id="validationDefault06" value="<?php echo $_POST['fdatav'];?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="validationDefault07">Observação:</label>
                            <input type="text" name="fobservacao" class="form-control" id="validationDefault07" value="<?php echo $_POST['fobservacao'];?>" optional>
                        </div>
                            <input type="hidden" name="fpassageiro" class="form-control" id="validationDefault08" value="<?php echo $campo['email'];?>">
                            <input type="hidden" name="fcodtimestamp" class="form-control" id="validationDefault09" value="<?php echo $_POST['fcodtimestamp'];?>">
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary btn-block col-md-6" style="margin-top:11px;margin-left:auto;margin-right:auto">Alterar</button>
                    </form>
                </div>
            </div>
    ...
    <script>
            ...
            var aba = document.getElementById("abacorridaspassageiro");
            aba.className+= " ativo";
