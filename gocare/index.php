...
<body>
    ...
    <section id="presentation1">
        ...
        <div id="title" style="color:white;text-align:center;position: absolute; left:18.5vw;top: 1.2vw;">
            <h1 style="font-size: 4.7vw;line-height:5.7vw"><b>Praticidade, Atenção e Confiança</b></h1>
        </div>
        <div id="description" style="color:white;text-align:center;position: absolute; left:23vw;top: 9vw;">
            <p style="font-size: 1.7vw;line-height:1.7vw">Quer viajar com conforto e segurança? A GoCare cuida de tudo para você!
            </p>
        </div>

        <!--Descrição-->

        <div id="topics" style="color:white;text-align:center;position: absolute; left:15vw;top: 24.8vw;">
            <p style="font-size: 1.7vw;line-height:1.7vw">• Carros adaptados<br><br>• Valores acessíveis<br><br>• Motoristas treinados
        ...
        <div>
            <div class="container-fluid" style="position: relative; left:0vw;top: -4vw;padding-left:0;padding-right:2.5;width: 70%;">
                <div class="card-group">
                    ...
                    <div class="card">
                        <img class="card-img-top" src="img/parceiro3.png" alt="Monalisa">
                        <div class="card-body">
