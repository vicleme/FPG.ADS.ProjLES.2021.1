            ...
            <div class="card" style="width: 70%;margin: auto;">
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <form action="editaperfilmotorista.php" method="post" enctype="multipart/form-data" style="margin: 1% 2%;">
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="cidade" name="fcidade" value="<?php echo $campo['cidade'];?>" maxlength=30 required>
                                </div>
