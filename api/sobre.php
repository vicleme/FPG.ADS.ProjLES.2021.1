            ...
            <section id="entrarpassageiromotorista">
                <div class="container-fluid" style="width: 90%;margin-top: 5%; margin-bottom: 5%;">
                        ...
                        <div class="card mb-3" style="align-content: center;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="img\favicon.ico" style="width: 100%; margin: 1%">

                            
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h4 class="card-title-primary">Quem somos?</h4>
                                        <hr>
                                        <p class="card-text text-break">Somos uma empresa prestadora de serviços eletrônicos na área do transporte privado urbano para pessoas especiais, através de um serviço web de transporte que permite o agendamento de viagens.</p>
                                        <p class="card-text text-break">A GoCare, é uma empresa brasileira que conta com a experiência consolidada de seus motoristas que possuem muitos anos de experiências no ramo de transporte privado urbano.</p>
